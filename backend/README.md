...
## Project Structure
    ...
    ├── healthcare_template_37789  # Django project configurations
...
1. Clone this repo and `cd healthcare_template_37789`
...
2. Clone this repo and `cd healthcare_template_37789`
